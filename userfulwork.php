...
<div class="Reveal">
	...
	<h1 class="blue heading">Userful Corp. </h1></div>	
		<div class="row mockupcontainer">
		<div class="Reveal col-xl-12"><img src="computerlaptopiphone.png" alt="photoshop mockup of the Userful Corp website. The mockup contains an ipad, iphone, imac and macbook. This shows the responsiveness of the website" class="mockupimage"></div>
		<div class="Reveal col-xl-12"><p class=" blue mockupdescription">At Userful, I had the task of redesigning their home page and 10 of their landing pages. Some of the challenges I encountered while doing this project include: They were stuck using and older version of Joomla along with an old template. On top of that, the old version of Joomla was using Bootstrap 2 which I never used before. I created a new theme inside of the current theme they were using. <em>Made With Joomla CMS & Bootstrap</em></p>
			<a href="http://www.userful.com"><p class="gotolivesite blue"><strong>Go to Live Site</strong><i class="fa fa-long-arrow-right fa-lg" aria-hidden="true"></i></p></a>
		</div>
