...
<div class="Reveal">
	...
	<h1 class="blue heading">The Magic of Christmas</h1></div>	
		<div class="row mockupcontainer">
		<div class="Reveal col-xl-12"><img src="santamockup.png" alt="photoshop mockup of the The Magic of Christmas website. The mockup contains an ipad, iphone, imac and macbook. This shows the responsiveness of the website" class="mockupimage"></div>
			<div class="Reveal col-xl-12"><p class=" blue mockupdescription">The Magic of Christmas is a 100% volunteer, non-denominational charity based in the City of Calgary. I worked together with two other web designers to re-design the Magic of Christmas website making it more accessible, easier to navigate and a giving it a sleek new look. <em>Made With Wordpress CMS</em></p>
			<a href="http://santa.drewliknes.com/"><p class="gotolivesite blue"><strong>Go to Live Site</strong><i class="fa fa-long-arrow-right fa-lg" aria-hidden="true"></i></p></a>
		</div>
