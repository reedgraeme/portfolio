...
<div class="Reveal">
	...
	<h1 class="blue heading">PointR Financial</h1></div>	
		<div class="row mockupcontainer">
		<div class="Reveal col-xl-12"><img src="pointrmockup.png" alt="photoshop mockup of the pointR financial website. The mockup contains an ipad, iphone, imac and macbook. This shows the responsiveness of the website" class="mockupimage"></div>
			<div class="Reveal col-xl-12"><p class=" blue mockupdescription">PointR financial is a fictitious investment firm that I created. The task was to create a website that was also a small business. The website required HTML5, CSS, PHP and JavaScript. The overall design of the site was simple yet professional. The design scheme consisted of white, black and blue. <em>Made with HTML and CSS</em></p>
			<a href="pointr/pointr.php"><p class="gotolivesite blue"><strong>Go to Live Site</strong><i class="fa fa-long-arrow-right fa-lg" aria-hidden="true"></i></p></a>
		</div>
